...
namespace mav_planning_rviz
{
  ...
  void PlanningPanel::registerPoseWidget(PoseWidget *widget)
  {
    ...
    connect(widget, SIGNAL(poseUpdated(const std::string &, mav_msgs::EigenTrajectoryPoint &)),
            this, SLOT(widgetPoseUpdated(const std::string &, mav_msgs::EigenTrajectoryPoint &)));
  }
