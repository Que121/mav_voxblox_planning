...
namespace loco_planner
{
  ...
  public:
    ...
    void setupFromTrajectoryPoints(
        ...
        const mgv_msgs::EigenTrajectoryPointMgv &goal_point, size_t num_segments,
        double total_time);
    ...
    void getTrajectory(mgv_trajectory_generation::Trajectory *trajectory) const;
  ...
  private:
    ...
    mgv_trajectory_generation::PolynomialOptimization<N> poly_opt_;
