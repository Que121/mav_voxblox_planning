...
#include <voxblox_planning_common/path_shortening_mgv.h>
#include <voxblox_loco_planner/shotgun_planner_mgv.h>
...
namespace mgv_planning
{
  ...
  public:
    ...
    bool getTrajectoryTowardGoalFromInitialTrajectory(
        double start_time,
        const mgv_trajectory_generation::Trajectory &trajectory_in,
        const mav_msgs::EigenTrajectoryPoint &goal,
        mgv_trajectory_generation::Trajectory *trajectory);
